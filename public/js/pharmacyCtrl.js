...
var pharmacyCtrl = angular.module('pharmacyCtrl', ['geolocation', 'gservice']);
pharmacyCtrl.controller('pharmacyCtrl', function($scope, $log, $http, $rootScope, geolocation, gservice){
   ...
   $scope.query = function(){
        ...
        $http.post('/api/queryPharmacies', queryBody).then(
                    function(response) {

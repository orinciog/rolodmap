...
var hospitalCtrl = angular.module('hospitalCtrl', ['geolocation', 'gservice']);
hospitalCtrl.controller('hospitalCtrl', function($scope, $log, $http, $rootScope, geolocation, gservice){
   ...
   $scope.query = function(){
        ...
        $http.post('/api/queryHospitals', queryBody).then(
                    function(response) {
